document.addEventListener("DOMContentLoaded", function () {
    ...
    // Create the Save to Wardrobe Button dynamically
    ...
    // Find the sidebar and insert the buttons below generateBtn
    ...
    generateBtn.addEventListener("click", async function () {
        ...
        const apiKey = "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"; // Replace with your actual Hugging Face API key
        ...
        try {
            ...
            // Show the download and save buttons
    ...
    // Save Image to Wardrobe (Stores in Local Storage as Base64)
